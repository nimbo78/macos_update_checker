...
Теперь можно добавлять и удалять цели уведомлений **прямо через бота**, без редактирования конфига:

```
/addtarget -1001234567890 Мой канал
/addtarget 123456789 Личный чат
/removetarget -1001234567890
```

Цели из `config.py` (статические) продолжают работать параллельно с динамическими.
